...
{
    /// <summary>
    /// <para>表示 [POST] /channels/ec/promoter/get_promoter_single_product_promotion_info 接口的请求。</para>
    /// </summary>
    public class ChannelsECPromoterGetPromoterSingleProductPromotionInfoRequest : WechatApiRequest, IInferable<ChannelsECPromoterGetPromoterSingleProductPromotionInfoRequest, ChannelsECPromoterGetPromoterSingleProductPromotionInfoResponse>
    {
        /// <summary>
