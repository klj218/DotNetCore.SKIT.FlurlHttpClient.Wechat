...
- Release 3.16.0 (2026-09-15)
    - **新增**：新增微信小店商家补寄物流相关接口。
    - **新增**：新增微信小店获取商品受限场景信息接口。
    - **新增**：新增微信小店联盟带货机构获取商品活动补贴信息接口。
    - **新增**：随官方更新微信小店客服消息相关接口模型。
    - **新增**：随官方更新微信小店联盟带货机构获取佣金单详情、获取机构配置达人佣金计划列表、获取机构选品广场商品列表、获取商品基础详情、获取某个推客某个商品的内嵌商品卡片等接口模型。

- Release 3.15.0 (2026-08-19)
    - **新增**：新增微信人脸核身相关接口。
    - **新增**：新增虚拟支付签约及订阅相关接口。
    - **新增**：新增微信小店资源管理视频上传相关接口。
    - **新增**：新增微信小店商品品牌推荐接口。
    - **新增**：新增微信小店商家处理极速换货用户退货接口。
    - **新增**：新增微信小店新增第三方货源等接口。
    - **新增**：新增微信小店获取类目下商品发布规则接口。
    - **新增**：新增微信小店获取商品推广计划列表和带货者列表接口。
    - **新增**：新增微信小店指定礼物单祝福语接口。
    - **新增**：新增微信小店提交发货申请和获取发货协商结果等接口。
    - **新增**：随官方更新搜一搜数据推送接口模型。
    - **新增**：随官方更新微信小店商品、订单、售后单、纠纷单等相关接口模型。
    - **新增**：随官方更新微信小店资金流水、优选联盟、连接小程序等相关接口模型。
    - **变更**：移除部分已标记为废弃的接口及模型。
    - **修复**：修复微信小店获取类目信息接口模型定义错误。（_via_ [GitHub #224](https://github.com/fudiwei/DotNetCore.SKIT.FlurlHttpClient.Wechat/issues/224)）

- Release 3.14.0 (2026-02-05)
    - **新增**：新增小程序品牌申请相关接口。
    - **新增**：新增微信小店类目规则、商品商家策略、合作商家为小程序发放礼物等相关接口。
    - **新增**：新增微信小店获取商品提审限额、订单补发货、申请关联供货商、查看订单真实号审核状态等接口。
    - **新增**：新增微信小店联盟带货机构更新或删除已添加的推广计划接口。
    - **新增**：随官方更新微信小店商品、订单、售后单等相关接口模型。
    - **新增**：随官方更新微信小店修改订单物流信息接口模型。
    - **新增**：随官方更新微信小店带货助手佣金单相关接口模型。
    - **新增**：随官方更新微信小店推客带货机构推广券相关接口模型。

- Release 3.13.0 (2025-11-27)
    - **新增**：新增小程序用工关系相关接口。
    - **新增**：新增微信小店获取店铺收藏人数接口。
    - **新增**：新增微信小店订单站外商品属性映射、商品发品前校验等接口。
    - **新增**：新增微信小店代用户发起退差价接口。
    - **新增**：新增微信小店小店会员相关接口。
    - **新增**：新增微信小店认证手机号相关接口。
    - **新增**：新增微信小店订单虚拟号于真实号码相关接口。
    - **新增**：新增微信小店联盟带货机构给帮卖机构供货、分发优惠券给其他机构等接口。
    - **新增**：随官方更新微信小店商品、订单、售后单等相关接口模型。
    - **新增**：随官方更新微信小店带货助手佣金单相关接口模型。
    - **新增**：随官方更新微信小店获取店铺基本信息接口模型。
    - **新增**：随官方更新微信小店获取电商数据概览接口模型。
    - **新增**：随官方更新微信小店获取资金流水详情接口模型。
    - **新增**：随官方更新微信小店查询送检配置模板信息接口模型。
    - **修复**：修复小程序会员服务相关接口模型定义错误。
...
- Release 3.18.0 (2026-09-10)
    - **新增**：新增平台收付通查询指定主体子商户列表接口。
    - **新增**：新增银行号码包查询上传任务列表接口。
    - **新增**：新增商品券多次优惠相关接口。
...
- Release 3.16.0 (2025-11-06)
    ...
    - **新增**：新增品牌活动投放计划相关接口。
    - **新增**：新增微信分付商户贴息相关接口。
    - **新增**：随官方更新平台收付通分账相关接口模型。（_via_ [GitHub #206](https://github.com/fudiwei/DotNetCore.SKIT.FlurlHttpClient.Wechat/issues/206)）
...
- Release 3.14.0 (2025-09-24)
    ...
    - **新增**：新增向用户发放商品券接口。
    - **新增**：新增平台收付通注销提现、账号托管模式等相关接口。
    - **新增**：新增商家转账发起免确认收款授权、解除免确认收款授权等接口。
    - **新增**：新增商户尽职调查相关接口。
    - **新增**：新增微信全数电发票相关接口。
    - **新增**：新增刷脸支付获取设备出厂检查结果接口。
    - **新增**：新增个人收款二手交易场景根据业务申请单号查签约信息接口。
    - **新增**：随官方更新平台收付通商家充值相关接口模型。
    - **新增**：随官方更新商户被管控能力及原因查询相关接口模型。
    - **新增**：随官方更新预约扣费服务直连商户 App 预签约接口模型。
    - **变更**：升级依赖 `BouncyCastle.Cryptography` 至 v2.6.2。
...
- Release 3.17.0 (2026-09-11)
    - **新增**：新增文档文件素材管理相关接口。
    - **新增**：新增获取文件内容存档授权成员列表接口。
    - **新增**：随官方更新批量获取审批单号接口模型。
    - **新增**：随官方更新安全管理查询截屏操作记录接口模型。
...
- Release 3.13.0 (2025-11-26)
    ...
    - **新增**：随官方更新获取会议详情接口模型。
    - **新增**：随官方更新打卡规则相关接口模型。
    - **新增**：随官方更新人事助手获取员工字段配置接口模型。
    - **新增**：随官方更新获取收集表答案接口模型。（_via_ [Gitee #17](https://gitee.com/fudiwei/DotNetCore.SKIT.FlurlHttpClient.Wechat/pulls/17)）
